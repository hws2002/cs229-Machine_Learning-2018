...
def plot_gda(x, y, theta, theta_0,save_path=None):
    """Plot dataset and fitted gaussian distribution analysis parameters.
    Args:
        x: Matrix of training examples, one per row.
        y: Vector of labels in {0, 1}.
        theta: Vector of parameters for GDA model.
        theta_0: scalar of parameter for GDA model.
        save_path: Path to save the plot.
    """
    # Plot dataset
    plt.figure()
